...
| [`agents`](packages/agents) | TypeScript SDK for running AI coding agents (Claude, Codex, Gemini, Goose, Kilo, OpenCode, Pi) in Daytona sandboxes | <a href="https://github.com/pluuto19"><img src="https://github.com/pluuto19.png?size=64" width="28" height="28"></a> <a href="https://github.com/jamesmurdza"><img src="https://github.com/jamesmurdza.png?size=64" width="28" height="28"></a> |
