...
| [`launcher`](packages/launcher) | `npx` launcher that runs the Background Agents desktop app | <a href="https://github.com/jamesmurdza"><img src="https://github.com/jamesmurdza.png?size=64" width="28" height="28"></a> |
