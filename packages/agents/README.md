...
A TypeScript SDK for running AI coding agents (Claude, Codex, Gemini, OpenCode, Picocode) in secure [Daytona](https://daytona.io) sandboxes. Designed for background execution with polling-based event streaming.
...
- **Unified API** — One interface for [Claude](https://docs.anthropic.com/en/docs/claude-code), [Codex](https://developers.openai.com/codex/cli), [Gemini](https://geminicli.com/docs/), [OpenCode](https://opencode.ai/docs/), and [Picocode](https://github.com/jondot/picocode)
...
| [Picocode](https://github.com/jondot/picocode) | ✅ | Provider-specific (e.g. `ANTHROPIC_API_KEY`, `OPENAI_API_KEY`, `GEMINI_API_KEY`) |
...
| Picocode | `picocode --yolo input "prompt"` |
...
| **Picocode** | `model: "anthropic/claude-3-opus"` | [Picocode docs](https://github.com/jondot/picocode#readme) |
...
**Agents** — [Claude Code](https://docs.anthropic.com/en/docs/claude-code) · [Codex CLI](https://developers.openai.com/codex/cli) · [Gemini CLI](https://geminicli.com/docs/) · [OpenCode](https://opencode.ai/docs/) · [Picocode](https://github.com/jondot/picocode)
