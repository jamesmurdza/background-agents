...
| **Codex** | `model: "gpt-5.4"`, `model: "gpt-5.3-codex"` | [Codex CLI](https://developers.openai.com/codex/cli) |
...
| **OpenCode** | `model: "opencode/big-pickle"` (free), `model: "anthropic/claude-sonnet-4-6"` | [OpenCode models](https://opencode.ai/docs/models/) |
| **Gemini** | `model: "gemini-2.5-flash"`, `model: "gemini-2.5-pro"`, `model: "gemini-3.1-pro-preview"` | [Gemini CLI](https://geminicli.com/docs/) |
| **Pi** | `model: "claude-sonnet-4-5"`, `model: "openai/gpt-4o"`, `model: "google/gemini-2.5-pro"` | [Pi CLI](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent#providers--models) |
