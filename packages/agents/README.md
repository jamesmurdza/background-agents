...
A TypeScript SDK for running AI coding agents (Claude, Codex, Gemini, Goose, Kilo, OpenCode, Pi) in secure [Daytona](https://daytona.io) sandboxes. Designed for background execution with polling-based event streaming.
...
| [Kilo](https://kilo.dev/docs/) | ✅ | `KILO_API_KEY` or none (free models available) |
...
| **Kilo** | `model: "kilo/kilo-auto/free"` (free), `model: "kilo/anthropic/claude-opus-4.7"` | [Kilo](https://kilo.dev/docs/) |
...
**Agents** — [Claude Code](https://docs.anthropic.com/en/docs/claude-code) · [Codex CLI](https://developers.openai.com/codex/cli) · [Gemini CLI](https://geminicli.com/docs/) · [Goose](https://block.github.io/goose/docs/) · [Kilo](https://kilo.dev/docs/) · [OpenCode](https://opencode.ai/docs/) · [Pi](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent)
