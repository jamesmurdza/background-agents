...
Shared utilities and types for the Background Agents monorepo. This package provides common functionality used across the monorepo, including agent configuration, GitHub API helpers, and utility functions.
