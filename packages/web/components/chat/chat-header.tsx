    ...
    >
      ...
      {renaming.renaming ? (
          ...
          {renaming.canSuggestName && (
            ...
            >
              {renaming.suggesting ? (
                ...
                <Sparkles className="h-2.5 w-2.5 shrink-0 text-muted-foreground/70 hover:text-foreground transition-colors" />
              )}
            </button>
          )}
        </div>
        ...
        <div className="flex items-center gap-1 min-w-0 ml-2.5 group/branch-section">
          ...
          >
            {/* Branch icon - shown by default, hidden on hover */}
            <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="shrink-0 text-muted-foreground group-hover/branch-link:hidden">
              <path fillRule="evenodd" d="M11.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5zm-2.25.75a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25zM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5zM3.5 3.25a.75.75 0 1 1 1.5 0 .75.75 0 0 1-1.5 0z" />
            </svg>
            {/* GitHub icon - hidden by default, shown on hover */}
            <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor" className="shrink-0 text-muted-foreground hidden group-hover/branch-link:block">
